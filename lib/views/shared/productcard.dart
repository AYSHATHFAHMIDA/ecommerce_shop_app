          ...
          child: Column(
            ...
            children: [
              Stack(
                children: [
                  Container(
                    height: MediaQuery.of(context).size.height*0.20,//(*0.23)
              ...
              Padding(
                ...
                children: [
                  Text(widget.name,
                    style: appStykeWithHt(36, Colors.black, FontWeight.bold, 1.1),),
                  Text(widget.category,
                    style: appStykeWithHt(18, Colors.grey, FontWeight.bold, 1.5),)
                ],
              ),),
              ...
              child: Row(
                ...
                children: [
                  Text(widget.price,style: appStyle(30, Colors.black, FontWeight.w600),),
                  Row(
                    children: [
